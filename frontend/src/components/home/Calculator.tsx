...
export default function Calculator() {
  ...
  const monthlyYield = Math.round(investment * (monthlyRate / 100));
  ...
  const chartData = Array.from({ length: 12 }, (_, i) => {
    ...
    return {
      ...
      totalValue: investment + (monthlyYield * month),
    };
  });
  ...
  const CustomTooltip = ({ active, payload, label }: any) => {
    if (active && payload && payload.length) {
      ...
      return (
        <div className="bg-navy-950/95 border border-gold-500/20 p-4 rounded-xl shadow-2xl backdrop-blur-md">
  ...
  return (
    <section className="py-24 relative overflow-hidden bg-navy-900 border-y border-gold-500/10">
      {/* Background elements */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          >
            Adjust your initial investment and targeted monthly return rate to map out your real-world physical asset growth.
          </motion.p>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-center">
          ...
          <motion.div 
            ...
            className="lg:col-span-4 bg-navy-950/80 backdrop-blur-xl border border-gold-500/20 rounded-3xl p-8 shadow-2xl relative flex flex-col justify-between"
          >
            ...
            <div className="space-y-10">
              ...
              <div>
                <div className="flex justify-between items-end mb-4">
                  <label className="text-sm font-medium text-gray-400 uppercase tracking-wider flex items-center">
                    <Coins className="w-4 h-4 mr-2 text-gold-500" /> Investment Amount
                  </label>
                ...
                <input 
                  ...
                  className="w-full h-2 bg-navy-800 rounded-lg appearance-none cursor-pointer accent-gold-500 outline-none"
                  style={{
                    background: `linear-gradient(to right, #d4af37 ${(investment - 10000) / (1000000 - 10000) * 100}%, #10172b ${(investment - 10000) / (1000000 - 10000) * 100}%)`
                  }}
                />
              ...
              <div>
                ...
                <input 
                  ...
                  className="w-full h-2 bg-navy-800 rounded-lg appearance-none cursor-pointer outline-none"
                  style={{
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="flex sm:flex-col items-center justify-between sm:justify-center p-4 rounded-xl bg-navy-900 border border-gold-500/10">
                ...
                <div className="flex sm:flex-col items-center justify-between sm:justify-center p-4 rounded-xl bg-navy-800 border border-gold-500/30 shadow-gold-glow/10 sm:transform sm:scale-105 z-10 relative">
          ...
          <motion.div 
            ...
            className="lg:col-span-8 bg-navy-950/40 backdrop-blur-md border border-gold-500/10 rounded-3xl p-6 lg:p-8 flex flex-col h-full min-h-[500px]"
          >
            <div className="mb-4 flex flex-col sm:flex-row justify-between items-start sm:items-end gap-2">
              ...
              <div className="w-full sm:w-auto text-left sm:text-right bg-navy-900 border border-gold-500/20 px-4 py-2 rounded-xl mt-2 sm:mt-0">
                ...
                <p className="text-xl sm:text-2xl font-mono font-bold text-gold-400">
                  ₹{(investment + (monthlyYield * 12)).toLocaleString('en-IN')}
                </p>
              </div>
            </div>
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-6 text-xs text-gray-400">
              <div className="flex items-center px-3 py-1.5 rounded-full bg-navy-900 border border-blue-500/20">
                <div className="w-2.5 h-2.5 rounded-full bg-blue-500 mr-2 opacity-80"></div>
                Principal Inv.
              </div>
              <div className="flex items-center px-3 py-1.5 rounded-full bg-navy-900 border border-gold-500/20">
