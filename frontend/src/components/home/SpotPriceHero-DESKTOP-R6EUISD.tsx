          ...
          >
              ...
              <AnimatePresence mode="wait">
                ...
                >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {error && (
                          <div className="flex items-center gap-1.5 text-xs text-red-400 bg-red-400/5 px-2 py-0.5 rounded-lg border border-red-400/10">
                            <AlertCircle size={12} /> Cached Rate
                          </div>
                        )}
                      </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1">
                      <p className="text-text-secondary text-[10px] font-bold tracking-widest uppercase opacity-40">Previous Position</p>
                    ...
                    <div className="space-y-1 flex flex-col items-end">
                      <p className="text-text-secondary text-[10px] font-bold tracking-widest uppercase opacity-40">Last Updated</p>
            ...
            <div className="flex flex-wrap items-center gap-6 pt-4">
              ...
              <div className="flex items-center gap-3 text-text-secondary/60 text-sm italic">
                ...
                Reflecting Global NSE Spot + Institutional Spread
              </div>
            </div>
